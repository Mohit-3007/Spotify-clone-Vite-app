...
export default function ArtistCard({ artistObj }) {
  ...
  return (
    <Link
      key={artistObj._id}
      className={
        "w-[168px] max-sm:h-[198px] sm:w-[47.30%] min-[800px]:w-[29.61%] min-[1000px]:w-[21.85%] min-[1310px]:w-[17.93%] 3xl:w-[14.91%] max-sm:ml-2 p-2 sm:p-4 rounded-xl shadow-xl relative transition-all duration-1000 " +
      ...
      <div className="w-[152px] max-sm:h-[152px] sm:w-full ">
        ...
        <div className="w-full sm:mb-4 relative">
          <div className="w-full h-full  ">
            <img
              className={
                "rounded-[50%] max-sm:shadow-md shadow-xl " +
                (hover ? "shadow-[#171717]" : "shadow-[#282828]")
              }
              src={artistObj?.image}
            />
          </div>
          {hover && (
            <div
              className={
                "w-[27%] h-[27%] bg-[#1ED760] rounded-[50%] flex items-center justify-center absolute top-[81.5%] right-4 " +
        ...
        <div className="w-full sm:h-[3.875rem] flex flex-col">
          ...
          <div className="h-[1.25rem] text-xs sm:text-sm text-[#A7A7A7]">
            <span className="flex items-center">Artist</span>
          </div>
        </div>
      </div>
    </Link>
