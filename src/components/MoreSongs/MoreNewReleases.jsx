...
export default function MoreNewReleases() {
    ...
    async function fetchData() {
      try{
        let resp = await fetch(
          `https://academics.newtonschool.co/api/v1/music/album?page=${page}&limit=24&sort={"release": "-1"}`,
          {
            headers: headers,
          }
        );
        ...
        console.log("MoreNewRelease ",result);
        setSongData(result);
        window.scrollTo(
          {
            top: 0,
