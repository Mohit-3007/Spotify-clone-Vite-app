...
export default function MoreExcited() {
    ...
    async function fetchData() {
      try{
        let resp = await fetch(
            `https://academics.newtonschool.co/api/v1/music/song?page=${page}&limit=24&filter={"mood": "excited"}`,
            {
                headers: headers,
            }
        );
        ...
        console.log("More Excited Songs page ",result);
        setSongData(result);
      }
      catch(error){
