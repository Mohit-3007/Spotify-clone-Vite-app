...
export default function MoreSoulSoother() {
    ...
    async function fetchData() {
      try{
        let resp = await fetch(
            `https://academics.newtonschool.co/api/v1/music/song?page=${page}&limit=24&filter={"featured": "Soul soother"}`,
            {
                headers: headers,
            }
        );
        ...
        console.log("More Soul Soother Songs page ",result);
        setSongData(result);
      }
      catch(error){
