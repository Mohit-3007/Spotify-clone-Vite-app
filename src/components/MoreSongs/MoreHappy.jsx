...
export default function MoreHappy() {
    ...
    async function fetchData() {
      try{
        let resp = await fetch(
            `https://academics.newtonschool.co/api/v1/music/song?page=${page}&limit=24&filter={"mood": "happy"}`,
            {
                headers: headers,
            }
        );
        ...
        console.log("More Happy Songs page ",result);
        setSongData(result);
      }
      catch(error){
