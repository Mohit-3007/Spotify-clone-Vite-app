...
const Navbar = ({
  ...
  const { handleLoginState, login, setSearchedData } = useContextProvider();
  ...
  async function makeFetchCall() {
    ...
    if (resp.ok) {
      ...
      console.log(`Error code: ${resp?.status}. No Data Found!`);
    }
  }
  ...
  return (
    <>
      ...
      <div
        className={
          "max-sm:w-screen w-[calc(100%-307px)] max-sm:z-20 h-14 sm:h-16 fixed sm:top-2 top-0 sm:right-2 z-20 left-0 sm:left-[18.6875rem] bg-[#121212] " +
          (popSettingDiv ? "hidden" : "")
        }
      >
        <header className="px-6 w-full h-full py-4 flex items-center justify-between relative">
          ...
          <div className="sm:hidden w-full flex items-center">
            ...
            <span className="w-8 h-9 ml-6 text-xl font-figtree font-bold text-white flex justify-center items-center">
              Spotify
            </span>
          </div>
          {/* For sm: search icon */}
          <div className="sm:hidden flex h-[2.125rem]">
            ...
            <div className="w-10 h-[2.125rem] flex justify-end items-start ml-2 hover:scale-110 ">
              <IoReorderThree
                className="text-white w-9 h-9"
                onClick={handlePopRendering}
              />
            </div>
          </div>
          ...
          <div className="w-[4.5rem] sm:flex justify-between hidden">
            <button
              className="h-8 w-8 bg-black rounded-[50%] justify-center items-center flex"
              onClick={() => {
                navigate(-1);
                window.scrollTo({
                  top: 0,
            ...
            <>
              {location.pathname === "/search" && (
                <div className="hidden sm:block h-12 w-[46.75rem] mr-[1.125rem] relative">
                  <input
                    ref={inputRef}
                    className="w-[22.75rem] h-full bg-[#2A2A2A] rounded-3xl py-1.5 px-10 flex justify-center items-center 
              ...
              {(location.pathname === "/" ||
                location.pathname === "/more-artist") && (
                <div className="hidden sm:block h-12 w-[46.75rem] mr-[1.125rem]"></div>
              )}

              <Link
                to={
                  "https://www.spotify.com/in-en/premium/?utm_source=app&utm_medium=desktop&utm_campaign=upgrade&ref=web_loggedout_premium_button"
                }
                target="_blank"
                className="max-lg:hidden font-figtree h-12 py-2 text-[#9B9B9B] text-base font-extrabold tracking-widest mr-2 hover:text-white
             hover:scale-[1.03]"
              >
                Premium
              </Link>
              ...
              <Link
                ...
                target="_blank"
                className="max-lg:hidden font-figtree h-12 py-2 text-[#9B9B9B] text-base font-extrabold tracking-widest mr-2
             ...
             hover:text-white hover:scale-[1.03]"
              ...
              <div className="hidden w-[12.8125rem] h-12 sm:flex">
                <button
                  className=" font-figtree w-[6rem] py-2 pl-2 pr-7 text-[#9B9B9B] font-bold hover:scale-[1.04] hover:text-white"
                ...
                <button className=" font-figtree w-[6.875rem] bg-white rounded-3xl flex justify-center items-center hover:scale-[1.04]">
                  <span
                    className="w-[6.8125rem] h-12 py-2 px-7 text-black flex items-center text-base font-bold"
          ...
          {login && (
            <>
              ...
              <div className="flex justify-center items-center">
                {/* Explore Premium */}
                <button
                  className=" w-[8.9375rem] hover:scale-[1.04] h-8 mr-2 text-black bg-white rounded-2xl font-figtree"
                ...
                {/* Install App */}
                <a
                  className="w-[7.375rem] h-8 text-white hover:scale-[1.04] hover:bg-[#392923] bg-[#080808] mr-2 rounded-2xl font-figtree
                ...
                {/* Notification Bell */}
                <button
                  className=" hover:scale-[1.04] bg-[#080808] rounded-[50%] mr-2 flex justify-center items-center"
                  onClick={() => navigate("/stay-tuned")}
                >
                ...
                <div className="w-[12.25rem] h-[7.625rem]">
                  <ul>
                    <li className="w-[11.75rem] h-[2.5rem]">
                      <Link
                        className=" py-3 pl-3 pr-2 text-white text-sm font-semibold"
                        to={"/changepassword"}
                      >
      ...
      {!login && (
        <div
          className={
            "bg-black w-full h-full px-10 mt-2 fixed top-0 left-0 z-30 " +
            (popSettingDiv ? "" : "hidden")
          }
        >
          {/* Un-Render div */}
          <button
            className="w-full p-3 h-10 flex justify-end"
            onClick={handlePopRendering}
          >
          ...
          <div className="h-12 py-2" onClick={() => navigate("/login")}>
            <span className="font-figtree text-2xl text-white font-bold">
              Login
            </span>
          </div>
          {/* SignUp */}
          <div className="h-12 py-2">
            <span
              className="font-figtree text-2xl text-white font-bold"
              onClick={() => navigate("/signup")}
            >
              Sign up
            </span>
          ...
          <div className="w-full font-figtree font-bold text-xl text-white flex flex-col gap-3 ">
            <button className="h-[33px] py-1 flex items-center">
              <span className="">
            ...
            <button className="h-[33px] py-1 flex items-center">
              <span className="https://www.spotify.com/in-en/privacy">
                <a href="">Privacy</a>
              </span>
            </button>
            <button className="h-[33px] py-1 flex items-center">
              <span className="https://www.spotify.com/in-en/legal/end-user-agreement/">
                <a href="">Terms</a>
              </span>
            </button>
          </div>
